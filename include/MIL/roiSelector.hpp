...
Rect selectROI(const String& windowName, InputArray img, bool showCrosshair = false, bool fromCenter = false)
{
    ROISelector selector;
...
void selectROIs(const String& windowName, InputArray img,
                             std::vector<Rect>& boundingBox, bool showCrosshair = false, bool fromCenter = false)
{
    ROISelector selector;
